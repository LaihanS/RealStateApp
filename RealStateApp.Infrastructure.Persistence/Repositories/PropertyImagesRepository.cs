...
{
    public class PropertyImagesRepository : GenericAppRepository<PropertyImages>, IPropertyImagesRepository
    {
        public readonly ApplicationContext identityccontext;

        private readonly IMapper mapper;

        public PropertyImagesRepository(IMapper mapper, ApplicationContext context) : base(context)
        {
