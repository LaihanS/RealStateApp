...
{
    public class MejoraRepository : GenericAppRepository<Mejora>, IMejoraRepository
    {
        public readonly ApplicationContext identityccontext;

        private readonly IMapper mapper;

        public MejoraRepository(IMapper mapper, ApplicationContext context) : base(context)
        {
