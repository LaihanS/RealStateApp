...
{
    public class VentaTypeRepository : GenericAppRepository<VentaType>, IVentaTypeRepository
    {
        public readonly ApplicationContext identityccontext;

        private readonly IMapper mapper;

        public VentaTypeRepository(IMapper mapper, ApplicationContext context) : base(context)
        {
